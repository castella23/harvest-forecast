...
You can use custom domains by deploying the project to platforms that support it, such as Netlify or Vercel. Visit their docs for more details on how to set up custom domains.